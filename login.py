...
def login():
    ...
    print(resp, resp.content.decode('utf8'))
...
def setCallback(auth, wid):
    ...
    data = {
        "httpUrl": "https://maris.serveo.net/api/callback",
        "type": 2
    }
    print('*** setCallback')
...
if auth != None:
    ...
    send('wxid_raxq4pq3emg212', '18356748488@chatroom', '测试发送接口', '你好')
